...
export let roteiros = [
    {
        id: 1,
        titulo: "Roteiro Cultural Potiguar",
        descricao: "Uma imersão na história, ciência e folclore de Natal através dos museus mais importantes e da fortaleza histórica da cidade.",
        duracao_estimada: "6 horas",
        locais_ids: [3, 9, 8]
    },
    {
        id: 2,
        titulo: "Roteiro Ambiental e Natureza",
        descricao: "Perfeito para quem quer respirar ar puro, fazer trilhas ecológicas e conhecer ecossistemas protegidos bem no meio da cidade.",
        duracao_estimada: "5 horas",
        locais_ids: [10, 11]
    },
    {
        id: 3,
        titulo: "Roteiro Religioso e Fé",
        descricao: "Contemple a evolução da arquitetura e da fé na capital potiguar, passando do estilo colonial do século XVII à grandiosidade moderna da nova Catedral.",
        duracao_estimada: "3 horas",
        locais_ids: [2, 12]
    },
    {
        id: 4,
        titulo: "Roteiro Esportivo e Aventura",
        descricao: "Um dia movimentado para quem curte atividade física, futebol e a adrenalina clássica das dunas do litoral.",
        duracao_estimada: "7 hours",
        locais_ids: [1, 6, 11]
    }
];